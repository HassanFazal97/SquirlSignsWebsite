        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-neutral-900">Connect With Us</h3>
              <div className="flex space-x-4">
                <SocialLink href="https://twitter.com" label="Twitter">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path></svg>
                </SocialLink>
                <SocialLink href="https://www.linkedin.com/company/squirl-signs/" label="LinkedIn">
                ...
                <SocialLink href="https://www.instagram.com/squirlsigns/" label="Instagram">
...
const ContactInfo = ({ icon, title, content, href }: { icon: React.ReactNode; title: string; content: string; href: string }) => (
  <div className="flex items-start space-x-4">
    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-primary-100 text-primary-600 flex-shrink-0">
      {icon}
    </div>
    <div>
...
const SocialLink = ({ children, href, label }: { children: React.ReactNode; href: string; label: string }) => (
  <a 
    href={href} 
    target="_blank" 
    rel="noopener noreferrer" 
    className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-100 text-neutral-700 hover:bg-primary-100 hover:text-primary-600 transition"
    aria-label={label}
  >
    {children}
  </a>
  ...
  const faqs = [
    {
      ...
      answer: "We typically respond to all inquiries within 24 business hours. For urgent matters, please indicate this in your message subject."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely! You can request a meeting through our contact form, and we'll coordinate with you to find a convenient time."
    },
  ];
